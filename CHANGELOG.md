...
## [2.2.3](https://github.com/NASA-AMMOS/AIT-DSN/compare/2.2.2...2.2.3) - 2026-09-22

### Merged

- Fix read the docs [`#220`](https://github.com/NASA-AMMOS/AIT-DSN/pull/220)
- Pad a short checksum word to four bytes, not by one byte [`#219`](https://github.com/NASA-AMMOS/AIT-DSN/pull/219)

### Commits

- Updating AIT-Core dependency to latest version + Fix lint errors [`324b061`](https://github.com/NASA-AMMOS/AIT-DSN/commit/324b0619929223f18d856f33651e14aba2fd4a57)
- ghsa-9mm7-x883-w33x: Sanitize path before writing to directory [`0f4ac56`](https://github.com/NASA-AMMOS/AIT-DSN/commit/0f4ac56aa87bf0fccb4b47326067dddcdf8600fb)
- Adding dependency to fix autobuild of docs [`81ee293`](https://github.com/NASA-AMMOS/AIT-DSN/commit/81ee29372773a7830eaa0cfad5362f5063b6efe3)
- Preparation for 2.2.2 release [`5569fcb`](https://github.com/NASA-AMMOS/AIT-DSN/commit/5569fcbb2499e965e5ffc93d027ae35656b4bff5)
- Separating doc requirements to match other AIT repos [`949345b`](https://github.com/NASA-AMMOS/AIT-DSN/commit/949345b247c4023c7c025bc9e0a7bdd35b060e7c)
- Updating readthedocs dependencies [`49ae494`](https://github.com/NASA-AMMOS/AIT-DSN/commit/49ae494f9af2e3c0de34dc2c65ccaad738b3abd5)
- Clean-up, remove unused sphinx autohttp [`105065a`](https://github.com/NASA-AMMOS/AIT-DSN/commit/105065a84a4902e200962194ebe3b6901930ccf7)
- Merge commit from fork [`8c33c51`](https://github.com/NASA-AMMOS/AIT-DSN/commit/8c33c51befdeda631cac7a54814d4c5eb8e9294a)

## [2.2.2](https://github.com/NASA-AMMOS/AIT-DSN/compare/2.2.1...2.2.2) - 2026-07-13

### Commits

- Merge commit from fork [`9dc163e`](https://github.com/NASA-AMMOS/AIT-DSN/commit/9dc163e006b8dc58388215071e5f5bc96248c293)
- GHSA-gj83-67wr-82mv: SLE auth for upload CLTU properly [`06d07d1`](https://github.com/NASA-AMMOS/AIT-DSN/commit/06d07d1a525602c62c6eaeaeff2544196f430340)
- Preparation for 2.2.1 release [`a46da4d`](https://github.com/NASA-AMMOS/AIT-DSN/commit/a46da4db37077f5f6e414e7f0a4c78dbf1d49806)
...
## [2.2.1](https://github.com/NASA-AMMOS/AIT-DSN/compare/2.2.0...2.2.1)

### Commits

- Merge commit from fork [`7adf1c3`](https://github.com/NASA-AMMOS/AIT-DSN/commit/7adf1c351a640909ef2c08dca51c7b1aa40a2f87)
- Revert "GHSA-gj83-67wr-82mv: Updating readthedocs documentation" [`7e5bf52`](https://github.com/NASA-AMMOS/AIT-DSN/commit/7e5bf52f491e47b037b869572592ee3a102463cc)
- GHSA-gj83-67wr-82mv: Updating readthedocs documentation [`7be95af`](https://github.com/NASA-AMMOS/AIT-DSN/commit/7be95afd6b9155cc52097111b889bf364c35388b)
- GHSA-gj83-67wr-82mv: Adding UDP_host configuration and unit test [`b32391b`](https://github.com/NASA-AMMOS/AIT-DSN/commit/b32391b91c374fe89ad593d6771a1536fa12dc1e)
- GHSA-gj83-67wr-82mv: Fixing tox and pytests [`80e6732`](https://github.com/NASA-AMMOS/AIT-DSN/commit/80e6732a2605bed6920b5a0cbd90cd7573c9bd15)
- GHSA-gj83-67wr-82mv: Update UDP server start-up to use configured host [`44a9bca`](https://github.com/NASA-AMMOS/AIT-DSN/commit/44a9bcadc548d29d3ce103e2e779d7e64dadd1ac)
