...
class DSN_server_class():
    ...
    def _route(self):
        ...
        self.DSN_api.route('/start/RAF', callback=self.raf_start_handler)
        self.DSN_api.route('/stop/RAF', callback=self.raf_stop_handler)
        self.DSN_api.route('/unbind/RAF', callback=self.raf_unbind_handler)
        self.DSN_api.route('/disconnect/RAF', callback=self.raf_disconnect_handler)
        self.DSN_api.route('/connect/RCF', callback=self.rcf_connect_handler)
        self.DSN_api.route('/bind/RCF', callback=self.rcf_bind_handler)
        self.DSN_api.route('/start/RCF', callback=self.rcf_start_handler)
        self.DSN_api.route('/stop/RCF', callback=self.rcf_stop_handler)
        self.DSN_api.route('/unbind/RCF', callback=self.rcf_unbind_handler)
        self.DSN_api.route('/disconnect/RCF', callback=self.rcf_disconnect_handler)
        self.DSN_api.route('/connect/CLTU', callback=self.cltu_connect_handler)
        self.DSN_api.route('/bind/CLTU', callback=self.cltu_bind_handler)
        self.DSN_api.route('/start/CLTU', callback=self.cltu_start_handler)
        self.DSN_api.route('/stop/CLTU', callback=self.cltu_stop_handler)
        self.DSN_api.route('/unbind/CLTU', callback=self.cltu_unbind_handler)
        self.DSN_api.route('/disconnect/CLTU', callback=self.cltu_disconnect_handler)
        self.DSN_api.route('/upload/CLTU', callback=self.cltu_upload_handler)
