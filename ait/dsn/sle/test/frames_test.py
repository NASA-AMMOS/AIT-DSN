...
class AosTest(unittest.TestCase):
    def setUp(self):
        ...
        self.virt_chan_map = {1: "b_pdu", 2: "m_pdu", 3: "vca_sdu", 4: "idle"}

        # The shared AOS config, indicating which optional fields exists and the
        # Virtual channel map
        self.aos_cfg = AOSConfig(
            virtual_channels=self.virt_chan_map,
    ...
    def test_decode_aos_bpdu(self):
        ...
        bpdu_idle = aos_frame[
            "bpdu_contains_idle_data"
        ]  ##True when (self['bpdu_bitstream_data_ptr'] == b'11111111111110')
