...
from ait.dsn.cfdp.pdu import FileData, Metadata, EOF, NAK, ACK
...
class Sender2NakTest(unittest.TestCase):
    ...
    def send(self, pdu):
        ...
        print '***CAUGHT SEND OF PDU***', type(pdu)
    ...
    def test_sender2_resends_segment_requests(self):
        """Ensure that sender received list if complete when simulating re-transmission of FD PDUs"""
