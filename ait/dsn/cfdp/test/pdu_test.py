...
class HeaderTest(unittest.TestCase):
    ...
    def test_header_encoding_decoding(self):
        ...
        self.assertEqual(
            self.fixture.pdu_data_field_length, pdu_object.pdu_data_field_length
        )
        ...
        self.assertEqual(
            self.fixture.destination_entity_id, pdu_object.destination_entity_id
        )
    ...
    def test_header_read_write(self):
        ...
        write_outgoing_pdu(
            self.fixture, pdu_filename=test_file, output_directory=TEST_DIRECTORY
        )
...
class MetadataTest(unittest.TestCase):
    ...
    def test_md_encoding_decoding(self):
        ...
        self.assertEqual(
            self.fixture.segmentation_control, pdu_object.segmentation_control
        )
...
class FileDataTest(unittest.TestCase):
    def setUp(self):
        ...
        fd = {"segment_offset": 0, "data": "Hello world this is file data."}
